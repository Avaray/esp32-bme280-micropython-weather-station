...
SERVER_SSID = (
    config.ADMIN_MODE_WIFI_SSID if config.ADMIN_MODE_WIFI_SSID else "Weather Station"
)
SERVER_AUTHMODE = (
    network.AUTH_OPEN
    if not config.ADMIN_MODE_WIFI_PASSWORD
    else network.AUTH_WPA_WPA2_PSK
)
SERVER_IP = "10.0.0.1"
